...
#Generate data
def gendata():
    obs_1 = pd.read_csv('C:/Users/SUMITKR/Documents/python/gmm/20febcluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
    obs_2=pd.read_csv('C:/Users/SUMITKR/Documents/python/gmm/28febcluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
    frames=[obs_1,obs_2]
