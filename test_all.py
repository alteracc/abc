...
#Generate data
def gendata():
#    obs_1=pd.read_csv('19Jancluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
    obs_2=pd.read_csv('30Jancluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
    obs_3=pd.read_csv('06febcluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
    obs_4=pd.read_csv('13febcluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
    obs_5=pd.read_csv('20febcluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
    obs_6=pd.read_csv('28febcluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
    obs_7=pd.read_csv('6marCluster.csv',usecols=[1,3,4],header=None,skiprows=[0])
...
train= obs1.sample(frac=0.95, random_state=1)
...
## accuracy
accuracy = model.score(test[3].values.reshape(len(test),1),test[[1,4]].values.reshape(len(test),2))
